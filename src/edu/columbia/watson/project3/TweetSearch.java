		...
		try
		{
			...
			{   
				...
				{	
					...
					String searchQuery = expandQuery(queryBean, 1,4, 0 , 100, searchQueryPower, expandedQueryList, expandedQueryScoreList);
					System.out.println(expandedQueryList.size());
					System.out.println("hello Query  " + searchQuery) ; 
